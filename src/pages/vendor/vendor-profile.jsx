...
const VendorProfile = () => {
  return (
    <div>
      ...
      <header>
        <div><img src={logoImg} alt="Sports Sphere Logo" /></div>
        <nav>
      ...
      <div className="container">
        <div className="profile-header">
          <img src="https://via.placeholder.com/130" alt="Vendor Profile Picture" id="vendorImage" />
        ...
        <div className="info-section">
          ...
          <div className="info-value" id="vendorEmail">alex@example.com</div>
        </div>

        <div className="info-section">
          <div className="info-title">Phone</div>
          <div className="info-value" id="vendorPhone">+1 555-123-4567</div>
        </div>

        <div className="info-section">
          <div className="info-title">Bio</div>
          <div className="info-value" id="vendorBio">
            Passionate about quality athletic gear, serving the sports community since 2010.
          </div>
        </div>
